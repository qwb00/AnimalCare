    ...
    return (
        <div className="flex space-x-8 mt-6 mb-8 ml-16 md:ml-24 xl:ml-36 text-gray-500 text-lg">
            {itemsToShow.includes("General") && (
                 <Link to="/:userID/general" className={getLinkClass(`/:userID/general`)}>
                    General
                </Link>
            )}
            ...
            {itemsToShow.includes("Medical Treatments") && (
                <Link to="/:userID/veterinarian-examinations" className={getLinkClass(`/:userID/veterinarian-examinations`)}>
                    Medical Treatments
                </Link>
