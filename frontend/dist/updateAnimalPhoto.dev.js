...
var API_BASE_URL = 'https://animalcaredb-3c73ac350ab8.herokuapp.com/api'; 

var animalId = '5bc27217-6817-40e4-b8d1-60dc9aca3e83'; 

var newPhotoUrl = 'https://images.unsplash.com/photo-1537204696486-967f1b7198c8?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'; 

var authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..ZSDw8ZF-Znhi96Oa4hYjn4cfFQB97HYB2_yi0s2ClpA';
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return regeneratorRuntime.awrap(axios.patch("".concat(API_BASE_URL, "/animals/").concat(animalId), 
          data, {
            headers: {
